      ...
      await createReview({
        variables: {
          data: {
            ...
            canAskTrainer: formData.canAskTrainer,
            ...
            overtimeHandling: formData.overtimeHandling?.length ? formData.overtimeHandling : undefined,
            overtimeHandlingOther: formData.overtimeHandlingOther || undefined,
            ...
            workplaceSafety: formData.workplaceSafety,
            genderDiscriminationExperienced: formData.genderDiscriminationExperienced,
            genderDiscriminationObserved: formData.genderDiscriminationObserved,
            ethnicityDiscriminationExperienced: formData.ethnicityDiscriminationExperienced,
            ethnicityDiscriminationObserved: formData.ethnicityDiscriminationObserved,
            disabilityDiscriminationExperienced: formData.disabilityDiscriminationExperienced,
            disabilityDiscriminationObserved: formData.disabilityDiscriminationObserved,
            discriminationExperienceText: formData.discriminationExperienceText || undefined,
